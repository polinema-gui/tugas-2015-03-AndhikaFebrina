    ...
    Private Sub Button2_Click(ByVal sender As Object, ByVal e As EventArgs) Handles Button2.Click
        Try
            Select Case Cmb_pola.Text
                Case "Pyramid"
                    pyramid(Convert.ToInt32(barisString.Text))
                Case "Hollow Pyramid"
                    hollowPyramid(Convert.ToInt32(barisString.Text))
                Case "Inverted Pyramid"
                    invertedPyramid(Convert.ToInt32(barisString.Text))
                Case "Hollow Inverted Pyramid"
                    hollowInvertedPyramid(Convert.ToInt32(barisString.Text))
                Case Else
                    barisString.Text = "Anda Belum Memilih Pola"
            End Select
        Catch ex As Exception
            barisString.Text = "Masukan Bukan Angka"
        End Try
    End Sub
